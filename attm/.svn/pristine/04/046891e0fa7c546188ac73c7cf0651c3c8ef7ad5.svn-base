...
*/
	...
	public List<ModelTicketSellCustom> getTicketSellChdByMstId2(Long ticketSellMstId) {
		...
		String qry="SELECT a.TICKET_SELL_CHD_ID,a.TICKET_SELL_MST_ID,a.TICKET_PURCHASE_CHD_ID,\r\n" + 
				...
				"a.TICKET_AMT_USD,a.TICKET_AMT_BDT,a.REMARKS,a.ACTIVE_STATUS,a.QTY\r\n" + 
		...
		/*
		 * SELECT a.TICKET_SELL_CHD_ID,a.TICKET_SELL_MST_ID,a.TICKET_PURCHASE_CHD_ID,
a.USER_ID,b.user_name,a.PNR,a.AGENT_PASSENGER_NAME,
a.TICKET_AMT_USD,a.TICKET_AMT_BDT,a.REMARKS,a.ACTIVE_STATUS,a.QTY
FROM attm_ticket_sell_chd a
Left outer JOIN bg_user b ON a.USER_ID=b.user_id
...
a.TICKET_AMT_USD,a.TICKET_AMT_BDT,a.REMARKS,a.ACTIVE_STATUS,a.QTY
		...
		MapSqlParameterSource parameters = new MapSqlParameterSource();
	      ...
	      System.out.println(" in daoTicketSellChdImp, ticketSellMstId:" +ticketSellMstId);
