...
@Controller
public class ObjectGroupControllerList {
 
	@Autowired
	private DaoObjectGroupImp objectGroupImp;
...
private Long systemUserId;
	...
	@RequestMapping(path = "/objectgroup/list/{userId}", method = RequestMethod.GET)
    public String getObjectGroupList(@PathVariable Long userId,Model model) {
	...
	@RequestMapping(path="/objectGroup/search")
	public String getUOMList(Model model,@RequestParam("groupName")String groupName,@RequestParam("shortCode")String shortCode
...
// left panel list
	...
	//left panel list
		...
		model.addAttribute("objectGroupList", objectGroupImp.getObjectGroupListByCraiteria(groupName, shortCode, remarks, status));	
		return "objectgrouplist";
	}
