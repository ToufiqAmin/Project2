...
import com.biziitech.attm.bg.model.ModelBranchUnitLoc;
import com.biziitech.attm.bg.dao.DaoBranchUnitLoc;
import com.biziitech.attm.bg.repository.BgBranchUnitLocRepository;
