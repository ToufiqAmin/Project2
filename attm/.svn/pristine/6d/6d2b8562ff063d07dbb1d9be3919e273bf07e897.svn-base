...
public class ModelModule {
	...
	public String toString() {
		return "ModelModule [moduleId=" + moduleId + ", moduleName=" + moduleName + ", modelSystem=" + modelSystem
				+ ", shortCode=" + shortCode + ", remarks=" + remarks + ", activeStatus=" + activeStatus
