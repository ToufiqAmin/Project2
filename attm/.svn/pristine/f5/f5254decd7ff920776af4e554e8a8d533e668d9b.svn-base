...
@Controller
public class BgUserTypeListController {
	...
	@RequestMapping(path="/bgusertypecontroller/list/{userId}")
	public String list(@PathVariable Long userId,Model model) {
		...
		//  for setup
		 ...
		 return "bgUserTypeList";
	}
	
	@RequestMapping(path="/bgusertypecontroller/search/{userId}")
	public String getUserTypeList(@PathVariable Long userId,Model model,
		...
		model.addAttribute("userTypeList",daoUserType_attm.getUserTypeListByCraiteria(userTypeName, shortCode, remarks, status));	
		return "bgUserTypeList";
	}
