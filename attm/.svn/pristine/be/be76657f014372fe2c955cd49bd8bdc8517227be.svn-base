...
public class AgentListController {
	...
	@RequestMapping(path="/agentListcontroller/init/{userId}")
	...
	@RequestMapping(path="/agentListcontroller/search/{userId}")
	public String getAgentList(@PathVariable Long userId,
			Model model, @RequestParam("agentName")String agentName,
		...
		model.addAttribute("agentList",daoAgent.getATTM_AgentByCraiteria(agentName, shortCode, remarks, status));	
		return "agentList";
	}
