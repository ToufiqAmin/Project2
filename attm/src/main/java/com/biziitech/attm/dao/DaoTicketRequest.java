...
public interface DaoTicketRequest {
	...
	public List<ModelTicketRequestCustom> getTicketRequestDetails(String requesterName, String requesterContactPhone, Long userName, Long fromAgentName, Long toAgentName, Long ownerCompanyName,Date fromDate,Date toDate, int status);
