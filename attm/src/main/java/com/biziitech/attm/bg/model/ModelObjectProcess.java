...
@Entity(name="BG_OBJECT_PROCESS")
public class ModelObjectProcess {
	
	@Id @GenericGenerator(name = "custom_sequence", strategy = 
			"com.biziitech.attm.IdGenerator")
	@GeneratedValue(generator = "custom_sequence")
	@Column(name="OBJECT_PROCESS_ID")
	private Long objectProcessId;
	...
	public ModelObjectProcess() {
		
	}

	public Long getObjectProcessId() {
		return objectProcessId;
	}

	public void setObjectProcessId(Long objectProcessId) {
	...
	public void setModelProcess(ModelProcess modelProcess) {
