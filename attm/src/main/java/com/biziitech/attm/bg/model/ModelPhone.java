...
public class ModelPhone {
	...
	public String toString() {
		return "ModelPhone [phoneId=" + phoneId + ", modelUser=" + modelUser + ", ownerTypeId="
				...
				+ ", contactPersonName=" + contactPersonName + ", contactEmail=" + contactEmail + ", active=" + active
				+ ", emergency=" + emergency + ", phoneType=" + phoneType + ", sActive=" + sActive + ", sEmergency="
				+ sEmergency + "]";
