...
public class AirLineController {
	...
	java.sql.Timestamp entryTime = new java.sql.Timestamp(date.getTime());
   	...
   	if(modelAirLine_ATTM.getAirLineId()==null )
   	{
   		...
   		modelTicketOwnerCompany.setContactName(existsAirLine.get().getContactName());
   		modelTicketOwnerCompany.setContactNo(existsAirLine.get().getContactNo());
   		modelTicketOwnerCompany.setOwnerCompanyName(existsAirLine.get().getAirLineName());
   		modelTicketOwnerCompany.setRemarks(existsAirLine.get().getRemarks());
   		modelTicketOwnerCompany.setShortCode(existsAirLine.get().getShortCode());
   		modelTicketOwnerCompany.setTicketType(1);
   		modelTicketOwnerCompany.setTicketOwnerCompanyId(existsAirLine.get().getAirLineId());
